...
echo -e "    smartsync-sound-service       8009"
...
if [ "$SS_BUILD" = true ] ; then
    ...
    mvn package
	echo e- "${C_YEL}cd smartsync-sound-service; mvn package${C_NRM}"
	cd ../smartsync-sound-service
	mvn package
...
echo -e "${C_YEL}java -jar smartsync-sound-service/target/smartsync-sound-service-0.0.1-SNAPSHOT.jar${C_NRM}"
java -Xms64m -Xmx64m -jar smartsync-sound-service/target/smartsync-sound-service-0.0.1-SNAPSHOT.jar &
PID11=$!
echo $PID11
